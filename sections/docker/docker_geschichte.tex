\subsubsection{Die Ausgangslage – dotCloud und das „Works on my Machine"\,\mbox{-}\,Problem}
...
war ein \textit{Platform-as-a-Service} (PaaS)-Anbieter, der Entwicklern ermöglichte, 
...
Am 13. März 2013 präsentierte Solomon Hykes Docker zum ersten Mal 
...
Die Reaktion auf die PyCon-Demo war so überwältigend, dass das 
ursprüngliche PaaS-Geschäft von dotCloud völlig in den Hintergrund 
rückte. Innerhalb weniger Monate zählte das GitHub-Repository 
...
\begin{itemize}
    ...
    Registry, in der Entwickler:innen fertige Container-Images teilen und 
    ...
    Finanzierungsrunde von 95 Millionen US-Dollar im Jahr 2015 
    \cite{datacenter_docker}.
\end{itemize}
...
gehört Docker zu den meistgenutzten Werkzeugen unter Entwickler:innen 
...
\textbf{containerd}, die ursprünglich Teil von Docker war, wurde 2016 
