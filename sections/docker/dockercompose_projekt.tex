...
alle Services miteinander kommunizieren.
...
wird hier mit dem Subnetz \texttt{10.4.0.0/16} angelegt und 
definiert. Der LearnHub Stack bindet dieses Netzwerk dann als 
externes Netzwerk ein, ohne es neu zu definieren, da es bereits 
hier erstellt wurde. Traefik erkennt automatisch welche Services 
