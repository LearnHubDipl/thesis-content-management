...
\begin{itemize}
  ...
  \item Erhöhte HTML-Lesbarkeit durch lange Klassenketten
\end{itemize}
...
gewählt.
Aus technischer Sicht wäre Tailwind CSS aufgrund der geringen
Bundle-Size und der maximalen Gestaltungsfreiheit eine geeignete
Alternative gewesen~\cite{tailwind2023docs}.
Angular Material hätte durch die native Angular-Integration ebenfalls
in Betracht gezogen werden können, erfordert jedoch ein tieferes
Verständnis des Angular-Material-Theming-Systems, was angesichts des
verfügbaren Zeitrahmens einen unverhältnismäßigen Mehraufwand bedeutet
hätte~\cite{angularmaterial2023docs}.
Der ausschlaggebende Faktor war die bestehende Vertrautheit des Teams
mit Bootstrap aus dem schulischen Unterricht.
Angular Material und Tailwind CSS waren zum Projektstart im Team noch
nicht bekannt, sodass eine Einarbeitungsphase den Entwicklungsprozess verzögert hätte.
Ein weiterer Vorteil von Bootstrap ist sein klares, schlichtes 
Designsystem: Die vordefinierten Komponenten und das Grid-System 
liefern ohne großen Konfigurationsaufwand eine konsistente und 
professionelle Benutzeroberfläche. Für ein Projekt mit begrenztem 
Zeitrahmen stellt dies einen erheblichen Vorteil dar, da gestalterische 
Entscheidungen weitgehend durch das Framework vorgegeben werden und 
der Fokus vollständig auf die funktionale Implementierung gelegt 
werden kann.