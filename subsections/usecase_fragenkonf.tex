...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Fragen mit Freigabeanfrage:} Schüler:innen können beim Erstellen einer Frage direkt eine Freigabe anfragen, damit diese von Admins geprüft und möglicherweise öffentlich gemacht wird.
    \end{itemize}
    \item Schüler:innen können ihre eigenen privaten Fragen bearbeiten und löschen.
    \item Alle öffentlichen Fragen sind für Schüler:innen sichtbar, können jedoch nur von Admins bearbeitet oder gelöscht werden.
...
\begin{itemize}
    \item Admins haben vollen Zugriff auf den öffentlichen Fragenpool.
    \item Sie können:
    \begin{itemize}
    ...
    \end{itemize}
    \item Admins haben Zugriff auf alle öffentlichen Fragen sowie auf Fragen, für die eine Freigabe angefragt wurde.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Admins: können öffentliche Fragen direkt erstellen oder private Fragen für sich selbst.
    ...
    \begin{itemize}
        \item Admins: können alle öffentlichen Fragen sowie eigene private Fragen bearbeiten oder löschen.
    ...
    \begin{itemize}
        ...
        \item Nur Admins können angefragte Fragen prüfen und bei öffentlich machen.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Admins sehen alle öffentlichen Fragen, Fragen mit Freigabeanfragen und eigene private Fragen.
    \end{itemize}
