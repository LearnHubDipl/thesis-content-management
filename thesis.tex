...
\begin{spacing}{1}
\chapter{Projektverwaltung}\label{chapter:projectmanagement}
\end{spacing}
\input{./sections/projectmanagement}


\begin{spacing}{1}
\chapter{Technologie-Entscheidungen}\label{chapter:tech}
\end{spacing}
\input{./sections/technologies}

\begin{spacing}{1}
\chapter{Praktische Umsetzung}\label{chapter:implementation}
\end{spacing}
